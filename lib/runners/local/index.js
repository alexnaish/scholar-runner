                ...
                client
                    ...
                    .then(function(size) {
                        ...
                        let cropRectangle = {
                            ...
                            top: elementBox.top,
                            width: browserCrop[browserCrop] ? Math.min(elementBox.width, size.width) : elementBox.width,
                            height: browserCrop[browserCrop] ? Math.min(elementBox.height, size.height) : elementBox.height
                        };
                        return client
                            .saveScreenshot()
                            .then((imageData) => {
